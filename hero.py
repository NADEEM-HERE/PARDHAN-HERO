...
def send_messages(tokens_file, target_id, messages_file, haters_name, speed):
 ...
 \033[1;35m _______  _______  _______  ______            _______  _       
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.RED + f"NADEEM KE TARAF SE SMS CHALA GAYA CONVO MAIN-[✅] PARDHAN TRICKER {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA + " NADEEM TRICKER TOOL ")
    print(Fore.CYAN + "------------------------------------")
